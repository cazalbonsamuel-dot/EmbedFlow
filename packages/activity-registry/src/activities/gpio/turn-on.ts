...
const turnOn: ActivityDefinition = {
  id: "gpio.turn_on",
  category: "Controle",
  label: "Allumer",
  icon: "💡",
  description: "Allume un composant (LED, lampe, ventilateur...)",
  color: "#f59e0b",
  ...
  properties: [
    {
      ...
      helpText: "Le type de composant a allumer",
    },
    {
      name: "pin",
      label: "Branche sur",
    ...
    },
    {
      ...
      level: "expert",
      default: false,
      helpText: "Inverser le niveau logique (LOW = allume)",
    },
  ],
  ...
  codegen: {
    ...
    loop: (props) => {
      ...
      return `digitalWrite(${pin}, ${inverted ? "LOW" : "HIGH"});`;
    },
  },
